...
private:
    ...
    void createTextureImageView() {
        this->textureImageView = this->createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT);
    }
    ...
    void createImageViews() {
        ...
        for (size_t i = 0; i < swapChainImages.size(); i++) {
            swapChainImageViews[i] = this->createImageView(swapChainImages[i], swapChainImageFormat, VK_IMAGE_ASPECT_COLOR_BIT);
        }
    }
